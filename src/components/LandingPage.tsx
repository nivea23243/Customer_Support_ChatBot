...
const NAV_ITEMS = [
  ...
  { name: 'Businesses', children: ['APIs', 'Biologics', 'Branded Formulations', 'Branded Generics', 'International (ISBU)', 'CDMO / CMO', 'Contract Research (CRO)', 'Herbal / Chezgreen', 'IRM Group Companies', 'Alliances', 'Sulfolane'] },
  { name: 'Research', children: ['World\'s First Innovations', 'R&D Chronicles', 'API Development', 'Formulation Development'] },
  { name: 'Therapies', children: ['Gastroenterology', 'Cardiology', 'Gynaecology', 'Diabetology', 'Oncology', 'Anti-Infective', 'Critical Care', 'Dermatology', 'Herbal', 'Neurology', 'Orthopaedic', 'Paediatric', 'Respiratory', 'Vaccines'] },
  { name: 'Careers', children: ['Life at Cadila', 'Growth & Development', 'Open Positions', 'Campus to Corporate'] },
  { name: 'Media', children: ['Press Releases', 'Events', 'In the News', 'Cadilogue'] },
];
        ...
        <div className="max-w-[1400px] mx-auto px-8 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-12 sm:gap-20 mb-24">
             ...
             <div className="space-y-8">
                ...
                <ul className="space-y-3 text-sm text-blue-100/70 font-medium">
                  {['APIs', 'Biologics', 'Branded Formulations', 'Branded Generics', 'International (ISBU)', 'CDMO / CMO', 'Contract Research (CRO)', 'Herbal / Chezgreen', 'IRM Group Companies', 'Alliances'].map(link => (
                    <li key={link}><a href="#" className="hover:text-orange-400 transition-colors">{link}</a></li>
                  ))}
                </ul>
             </div>
